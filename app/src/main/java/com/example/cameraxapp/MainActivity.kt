...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Inicializar el launcher para seleccionar imagenes
        selectImageLauncher = registerForActivityResult(
            ...
            if (result.resultCode == RESULT_OK && result.data != null) {
                ...
                selectedImageUri?.let {
                    openImageDisplayActivity(it)
                }
            }
        }

        // Inicializar el launcher para seleccionar videos
        selectVideoLauncher = registerForActivityResult(
            ...
            if (result.resultCode == RESULT_OK && result.data != null) {
                ...
                selectedVideoUri?.let {
                    openVideoDisplayActivity(it)
                }
            }
        }

        // Abrir el picker de imagenes
        selectImageButton.setOnClickListener {
            openImagePicker()
        }

        // Abrir el picker de videos
    ...
    private fun openImageDisplayActivity(imageUri: Uri) {
        val intent = Intent(this, ImageDisplayActivity::class.java)
        intent.putExtra("image_uri", imageUri)
        startActivity(intent)
    }

    private fun openVideoDisplayActivity(videoUri: Uri) {
